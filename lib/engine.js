 ...
 * */
// TODO: Once everyone in CLI is using promises, I can get rid of this.
var AsynchronousCall = module.exports.AsynchronousCall = function(fn,args/*...*/) {
    ...
    // During the process of changing to a promise, I can use this
    // where I would normally be calling run from another command.
    // Eventually, this function would replace 'run', and not long
    // after that, AsynchronousCall would be removed.
    this.runPromise = Q.nbind(this.run,this);
}
 ...
 * 
 * */
 // TODO: Once everything in CLI is using promises, get rid of this.
 ...
 * 
 ...
 // TODO: Remove this and references to it once Core is promisified.
 module.exports.callbackToPromise = Q.nbind.bind(Q);
