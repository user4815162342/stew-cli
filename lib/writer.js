 ...
 * - "glyph": contains text to be used as a glyph for the item.
*/
...
// TODO: It might be nice to allow for an option on how to style the list.
// This could just as easily be done with a "listStyle" member on the Array,
// although it could also be done with another formatting object. Basically,
// the available styles would mirror css, it can even make use of unicode:
// - disc | circle | square | asterisk | dash | <string>
...
// TODO: Need to support changing the mode. This would probably be a dot command (like .exit and .break).
...
if (!module.parent) {
    ...
    var glyphed = { "glyph": "?" }
    console.log("value with glyph:",writer(new formatting.Style(glyphed,"This is a test.")));
    // TODO: Test the glyphs in a table.
    ...
    table.addRow({ foo: new formatting.Style(glyphed,"Glyphed!"), bar: "Sea"});
