...
var applyStyleAndSelectors = function(doc,table,selectors,recurse,cb) {
    ...
    return getters.category()(doc).then(function(fv) {
        ...
        return engine.callbackToPromise(project.stew,project)().then(function(stew) {
            var style;
...
module.exports = engine.promiseCommand(function(doc,filter,selectors) {
    return manager.requireRelativeDoc(doc).then(function(doc) {
        if (doc) {
            ...
            if (typeof filter !== "undefined") {
                ...
                filter = function(doc,cb) {
                    return checkFilter(doc,function(err,pass,recurse) {
                        ...
                        table.addRow();
                        return applyStyleAndSelectors(doc,table,selectors.slice(0),recurse).then(function() {
            ...
            return engine.callbackToPromise(doc.listDocs,doc)(filter).then(function(list) {
