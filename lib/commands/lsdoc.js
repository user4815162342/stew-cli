...
// But, since all that's left is command, and that was originally put
// in to get synopsis, and we can get this via selectors, I'm not so
// certain.
    ...
    manager.requireRelativeDoc(doc,function(err,doc) {
        ...
        if (doc) {
            ...
            if (typeof selector === "undefined") {
                ...
                // we were passed a single selector.
                selector = [
                    nameSelector(basePath,30),
                    selector
                ]
            } else {
